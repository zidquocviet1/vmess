...
public final class Const {
    ...
    public static final String ADDED_MEMBER_CHAT_ID = "ADDED_MEMBER_CHAT";
    public static final String CHANGE_GROUP_NAME_CHAT_ID = "CHANGE_GROUP_NAME_CHAT";
    public static final String REMOVE_MEMBER_CHAT_ID = "REMOVE_MEMBER_CHAT";
    public static final String MEMBER_LEAVE_GROUP_CHAT_ID = "MEMBER_LEAVE_GROUP_CHAT";
    public static final String CHANGE_GROUP_THUMBNAIL_ID = "CHANGE_GROUP_THUMBNAIL_CHAT";
