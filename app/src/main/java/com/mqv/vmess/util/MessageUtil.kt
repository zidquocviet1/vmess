...
object MessageUtil {
    const val DUMMY_FIRST_CHAT_PREFIX = "DUMMY_FIRST_CHAT"
    const val WELCOME_CHAT_PREFIX = "WELCOME_CHAT"
    const val ADDED_MEMBER_CHAT_ID = "ADDED_MEMBER_CHAT"
    const val CHANGE_GROUP_NAME_CHAT_ID = "CHANGE_GROUP_NAME_CHAT"
    const val REMOVE_MEMBER_CHAT_ID = "REMOVE_MEMBER_CHAT"
    const val MEMBER_LEAVE_GROUP_CHAT_ID = "MEMBER_LEAVE_GROUP_CHAT"
    const val CHANGE_GROUP_THUMBNAIL_ID = "CHANGE_GROUP_THUMBNAIL_CHAT"
